    ...
    <section id='about' className='bg-[url(./assets/about.jpg)] pb-8 overflow-x-hidden'>
      <Container>
        <div className='text-center md:text-left'>
          <motion.h2 
            className='text-[28px] text-[#e24c4cea] pt-[60px] md:pt-[80px] lg:pt-[100px] font-bold font-open pb-2'
            variants={slideInUp}
            initial="initial"
            whileInView="animate"
          ...
          <motion.h4 
            className='text-[#000000] text-[40px] font-bold pb-16'
            variants={slideInUp}
            initial="initial"
            whileInView="animate"
            viewport={{ once: false, amount: 0.5 }}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-2 lg:gap-20'>
          ...
          <div>
            ...
            transition={{ duration: 0.8 }}
            className='text-black text-[24px] md:text-[22px] lg:text-[28px] tracking-[5px] uppercase font-bold font-syne pb-6'>// Biography</motion.h2>
            <motion.p
            variants={slideInLeft}
            initial="initial"
            whileInView="animate"
            ...
            <motion.div className='mt-8 mb-16 md:mb-12'
